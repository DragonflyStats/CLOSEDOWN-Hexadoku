...
Kappa is a similar measure to accuracy(), but is normalized by the accuracy that would be ex-
pected by chance alone and is very useful when one or more classes have large frequency distribu-
tions.
