...
Calculate the Huber loss, a loss function used in robust regression. This loss function is less sensitive
to outliers than rmse(). This function is quadratic for small residual values and linear for large
residual values.
...
na_rm = TRUE, ...)
huber_loss_vec(truth, estimate, delta = 1, na_rm = TRUE, ...)24
huber_loss
...
size <- 100
times <- 10
# create 10 resampleshuber_loss_pseudo
25
