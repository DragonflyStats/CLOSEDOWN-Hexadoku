...
#### Description
A list of two datasets, vertices and edges, containing information on sexual advances made in the
TV show Mad Men. This data set was first compiled by Winston Chang for the package gcookbook
(under the name madmen2) and was extended here to include the gender of each of the characters.
...
– Name1: Character variable with name of the character who made a sexual advance toward
the character in Name2
