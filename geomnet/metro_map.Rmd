...
#### Description
A dataset containing information to draw a map of Rockville, MD, and vicinity using ggmap. This
information was pulled from Google Maps using the ggmap package.
Usage
metro_map
Format
