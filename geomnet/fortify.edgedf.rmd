fortify.edgedf Function for converting a network edge list in data frame form into
the correct format for use with geomnet
#### Description
Function for converting a network edge list in data frame form into the correct format for use with
geomnet
...
group character. Used for facetting. If you wish to facet on network variable provide
the name of that variable here.
