...
fortify.network Function for converting a network object into the correct format for
use with geomnet
#### Description
...
group character. Used for facetting. If you wish to facet on a network variable provide
