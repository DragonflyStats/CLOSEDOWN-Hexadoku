...
Suitable donors are searched based on matching of the categorical variables. The variables are
dropped in reversed order, so that the last element of ’match_var’ is dropped first and the first
element of the vector is dropped last.
...
imp_suffix suffix for the TRUE/FALSE variables showing the imputation statusmatrixplot
39
