...
Implementation of the popular Sequential, Random (within a domain) hot-deck algorithm for im-
putation.
...
imp_var = TRUE, imp_suffix = "imp")26
hotdeck
Arguments
...
donorcond list of length equal to the number of variables, with a donorcond condition for
the donors e.g. ">5"
