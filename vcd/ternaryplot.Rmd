...
coordinates if TRUE, the coordinates of the points are plotted below them. coordinates and
id are mutual exclusive.
...
be scaled relative to the default. Ignored for the symbol size if prop_size is not
FALSE.
