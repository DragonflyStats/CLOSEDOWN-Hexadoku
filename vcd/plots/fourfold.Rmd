...
conf_* `` level`` : confidence level used for the confidence rings on the odds ratios. Must be a single on-negative number less than 1; if set to 0, confidence rings are suppressed.
