...
just justification of the legend relative to its (x, y) location. see ?viewport for more
details.
...
inset numeric vector of length 2 specifying the inset of the legend in npc units, relative
