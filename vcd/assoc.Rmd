...
the total heights (widths) of the rows (columns) are all equal. If TRUE, the space
between rows and columns is fixed and hence the plot is more “compressed”.
