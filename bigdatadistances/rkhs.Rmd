...
This function allows you to fit discrete functional data (fdframe) as functions in RKHS solving a
regularization problem as stated in Munoz (2010).
Usage
rkhs(fdframe, gamma=1, kerfunc='rbf',
kerpar=list(sigma=1, bias=0, degree=2))10
rkhs
#### Arguments 
