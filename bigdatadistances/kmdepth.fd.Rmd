...
robust TRUE if the covariance matrix is estimated through Robust Maximum Likeli-
hood method.
h numeric parameter controlling the a-prioir precentage of outliers in the sample
(value between 0 and 1, by def = 0.1).
