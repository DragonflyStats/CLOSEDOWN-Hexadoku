...
'TRUE') or not.
grobFun The function to be used to create the grob when 'test = TRUE' (e.g. 'textGrob',
'polygonGrob', etc.).
name The name to be used for the returned grob.
... The 
</code></pre>
#### Arguments 
 to be given to the 'grobFun' (or to 'grob()' when 'test = FALSE').
Value
A grob as produced by either the 'grobFun' given or by 'grob()' using the remaining 
</code></pre>
#### Arguments 
. If
'test = FALSE' then the name is suffixed by ": 'grobFun name' 
</code></pre>
#### Arguments 
".
