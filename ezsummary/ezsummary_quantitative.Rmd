ezsummary_quantitative() Easily summarize quantitative data
#### Description 
...
#### Usage 
<pre><code>
ezsummary_quantitative(tbl, total = FALSE, n = FALSE, missing = FALSE, mean = TRUE, sd = TRUE, sem = FALSE, median = FALSE,
quantile = FALSE, extra = NULL, digits = 3, rounding_type = c("round", "signif", "ceiling", "floor"), round.N = 3, flavor = c("long", "wide"),
fill = 0, unit_markup = NULL)

ezsummary_q(tbl, total = FALSE, n = FALSE, missing = FALSE, mean = TRUE, sd = TRUE, sem = FALSE, median = FALSE, quantile = FALSE,
extra = NULL, digits = 3, rounding_type = c("round", "signif", "ceiling", "floor"), round.N = 3, flavor = c("long", "wide"), fill = 0,
unit_markup = NULL)
