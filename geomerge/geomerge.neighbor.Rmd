...
#### Description
Auxiliary function that uses functionality from spdep to retrieve first and second order neighbor
weights.
#### Usage
...
Details
The function serves as a wrapper for the poly2nb, nblag and nb2listw functions from spdep and
returns first and second order neighbor weights using zero.policy = TRUE.
Value
