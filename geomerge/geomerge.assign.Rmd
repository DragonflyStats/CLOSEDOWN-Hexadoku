...
geomerge.assign Implements different assignment rules using SQL [Auxiliary Function]
...
* assignment identification of either population- or area-weighting assignment rules when handling SpatialPolygonsDataFrame joins to target. Default = "``max(area)``". See Details in geomerge.
