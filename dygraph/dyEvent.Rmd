...
x Either numeric or date/time for the event, depending on the format of the xaxis
of the dygraph. (For date/time must be a POSIXct object or another object
convertible to POSIXct via as.POSIXct)
label Label for event. Defaults to blank.
labelLoc Location for label (top or bottom)
color Color of event line. This can be of the form "#AABBCC" or "rgb(255,100,200)"
or "yellow". Defaults to black.
