...
fbh_test Apply z-test for difference between auc_1 and auc_2 using FBH
method.
Description
...
Arguments
auc_1 value of A’ statistic (or AUC, or Area Under the Receiver operating characteristic
curve) for the first group (numeric).
auc_2 value of A’ statistic (or AUC, or Area Under the Receiver operating characteristic
curve) for the second group (numeric).
n_p number of positive observations (needed for calculation of standard error of
Wilcoxon statistic) (numeric).
n_n number of negative observations (needed for calculation of standard error of
Wilcoxon statistic) (numeric).
Value
