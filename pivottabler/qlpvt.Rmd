...
the pivot table.
... Additional arguments, currently format, formats, totals, argumentCheckMode,
compatibility, caption and/or label. See the Latex output vignette for a descrip-
tion of caption and label.
Value
Latex.
