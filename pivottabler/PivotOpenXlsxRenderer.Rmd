...
The PivotOpenXlsxRenderer class creates a representation of a pivot table in an Excel file using the
openxlsx package.
...
Fields
parentPivot Owning pivot table.38
PivotOpenXlsxStyle
Methods
...
writeToCell(wb=NULL, wsName=NULL, rowNumber=NULL, columnNumber=NULL, value=NULL, applyStyles=TRUE, b
