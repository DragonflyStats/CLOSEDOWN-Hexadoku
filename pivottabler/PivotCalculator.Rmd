...
to intersect the filters coming from the row and column headings for a particular cell).PivotCell
25
...
type.
evaluateCell(cell) Top-level calculation function responsible for calculating the value of a
pivot table cell.
