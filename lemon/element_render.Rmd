...
#### Description
Helps add the ggplot2-theme's look-and-feel to grid's grob objects. render_gpar returns a gpar-
object, element_render returns a grid.grob-object.
...
Author(s)
element_render is from ggplot2 source.10
geom_pointpath
