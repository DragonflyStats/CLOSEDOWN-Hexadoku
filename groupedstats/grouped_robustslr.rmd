...
Function to run robust simple linear regression (slr) on multiple variables across multiple grouping
variables.
...
* dep.vars List criterion or dependent variables for regression (y
in
y ~ x
).
* indep.vars List predictor or independent variables for regression (
x in y ~ x ).
